...
func (a *ProjectApiService) GetProject(ctx context.Context, companyId string, projectId string, localVarOptionals *GetProjectOpts) (Project, *http.Response, error) {
	var (
...
@return CompaniesApiProjectsResponse
*/
...
func (a *ProjectApiService) ListProjects(ctx context.Context, companyId string, localVarOptionals *ListProjectsOpts) (CompaniesApiProjectsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiProjectsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiProjectsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
@return Project
*/
func (a *ProjectApiService) PatchProject(ctx context.Context, companyId string, projectId string, contentType string, ifMatch string, body Project) (Project, *http.Response, error) {
	var (
...
@return Project
*/
func (a *ProjectApiService) PostProject(ctx context.Context, companyId string, contentType string, body Project) (Project, *http.Response, error) {
	var (
