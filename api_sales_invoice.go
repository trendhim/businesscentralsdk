...
/* 
SalesInvoiceApiService cancelActionSalesInvoices
...
/* 
SalesInvoiceApiService cancelAndSendActionSalesInvoices
...
/* 
SalesInvoiceApiService deleteSalesInvoice
...
/* 
SalesInvoiceApiService getSalesInvoice
...
func (a *SalesInvoiceApiService) GetSalesInvoice(ctx context.Context, companyId string, salesInvoiceId string, localVarOptionals *GetSalesInvoiceOpts) (SalesInvoice, *http.Response, error) {
	var (
...
/* 
SalesInvoiceApiService listSalesInvoices
...
@return CompaniesApiSalesInvoicesResponse
*/
...
func (a *SalesInvoiceApiService) ListSalesInvoices(ctx context.Context, companyId string, localVarOptionals *ListSalesInvoicesOpts) (CompaniesApiSalesInvoicesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiSalesInvoicesResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiSalesInvoicesResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
SalesInvoiceApiService makeCorrectiveCreditMemoActionSalesInvoices
...
/* 
SalesInvoiceApiService patchSalesInvoice
...
@return SalesInvoice
*/
func (a *SalesInvoiceApiService) PatchSalesInvoice(ctx context.Context, companyId string, salesInvoiceId string, contentType string, ifMatch string, body CompaniesApiSalesInvoicesApiRequest) (SalesInvoice, *http.Response, error) {
	var (
...
/* 
SalesInvoiceApiService postActionSalesInvoices
...
/* 
SalesInvoiceApiService postAndSendActionSalesInvoices
...
/* 
SalesInvoiceApiService postSalesInvoice
...
@return SalesInvoice
*/
func (a *SalesInvoiceApiService) PostSalesInvoice(ctx context.Context, companyId string, contentType string, body CompaniesApiSalesInvoicesRequest) (SalesInvoice, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
SalesInvoiceApiService sendActionSalesInvoices
