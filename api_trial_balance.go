...
/* 
TrialBalanceApiService getTrialBalance
...
func (a *TrialBalanceApiService) GetTrialBalance(ctx context.Context, companyId string, trialBalanceNumber string, localVarOptionals *GetTrialBalanceOpts) (TrialBalance, *http.Response, error) {
	var (
...
/* 
TrialBalanceApiService listTrialBalance
...
@return CompaniesApiTrialBalanceResponse
*/
...
func (a *TrialBalanceApiService) ListTrialBalance(ctx context.Context, companyId string, localVarOptionals *ListTrialBalanceOpts) (CompaniesApiTrialBalanceResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiTrialBalanceResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiTrialBalanceResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
