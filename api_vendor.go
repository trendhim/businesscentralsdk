...
func (a *VendorApiService) GetVendor(ctx context.Context, companyId string, vendorId string, localVarOptionals *GetVendorOpts) (Vendor, *http.Response, error) {
	var (
...
@return CompaniesApiVendorsResponse
*/
...
func (a *VendorApiService) ListVendors(ctx context.Context, companyId string, localVarOptionals *ListVendorsOpts) (CompaniesApiVendorsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiVendorsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiVendorsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
@return Vendor
*/
func (a *VendorApiService) PatchVendor(ctx context.Context, companyId string, vendorId string, contentType string, ifMatch string, body CompaniesApiVendorsApiRequest) (Vendor, *http.Response, error) {
	var (
...
@return Vendor
*/
func (a *VendorApiService) PostVendor(ctx context.Context, companyId string, contentType string, body CompaniesApiVendorsRequest) (Vendor, *http.Response, error) {
	var (
