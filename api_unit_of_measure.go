...
/* 
UnitOfMeasureApiService deleteUnitOfMeasure
...
/* 
UnitOfMeasureApiService getUnitOfMeasure
...
func (a *UnitOfMeasureApiService) GetUnitOfMeasure(ctx context.Context, companyId string, unitOfMeasureId string, localVarOptionals *GetUnitOfMeasureOpts) (UnitOfMeasure, *http.Response, error) {
	var (
...
/* 
UnitOfMeasureApiService listUnitsOfMeasure
...
@return CompaniesApiUnitsOfMeasureResponse
*/
...
func (a *UnitOfMeasureApiService) ListUnitsOfMeasure(ctx context.Context, companyId string, localVarOptionals *ListUnitsOfMeasureOpts) (CompaniesApiUnitsOfMeasureResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiUnitsOfMeasureResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiUnitsOfMeasureResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
UnitOfMeasureApiService patchUnitOfMeasure
...
@return UnitOfMeasure
*/
func (a *UnitOfMeasureApiService) PatchUnitOfMeasure(ctx context.Context, companyId string, unitOfMeasureId string, contentType string, ifMatch string, body UnitOfMeasure) (UnitOfMeasure, *http.Response, error) {
	var (
...
/* 
UnitOfMeasureApiService postUnitOfMeasure
...
@return UnitOfMeasure
*/
func (a *UnitOfMeasureApiService) PostUnitOfMeasure(ctx context.Context, companyId string, contentType string, body UnitOfMeasure) (UnitOfMeasure, *http.Response, error) {
	var (
