...
/* 
AgedAccountsReceivableApiService getAgedAccountsReceivable
...
func (a *AgedAccountsReceivableApiService) GetAgedAccountsReceivable(ctx context.Context, companyId string, agedAccountsReceivableCustomerId string, localVarOptionals *GetAgedAccountsReceivableOpts) (AgedAccountsReceivable, *http.Response, error) {
	var (
...
/* 
AgedAccountsReceivableApiService listAgedAccountsReceivable
...
@return CompaniesApiAgedAccountsReceivableResponse
*/
...
func (a *AgedAccountsReceivableApiService) ListAgedAccountsReceivable(ctx context.Context, companyId string, localVarOptionals *ListAgedAccountsReceivableOpts) (CompaniesApiAgedAccountsReceivableResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiAgedAccountsReceivableResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiAgedAccountsReceivableResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
