...
func (a *ItemApiService) GetItem(ctx context.Context, companyId string, itemId string, localVarOptionals *GetItemOpts) (Item, *http.Response, error) {
	var (
...
@return CompaniesApiItemsResponse
*/
...
func (a *ItemApiService) ListItems(ctx context.Context, companyId string, localVarOptionals *ListItemsOpts) (CompaniesApiItemsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiItemsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiItemsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
@return Item
*/
func (a *ItemApiService) PatchItem(ctx context.Context, companyId string, itemId string, contentType string, ifMatch string, body CompaniesApiItemsApiRequest) (Item, *http.Response, error) {
	var (
...
@return Item
*/
func (a *ItemApiService) PostItem(ctx context.Context, companyId string, contentType string, body CompaniesApiItemsRequest) (Item, *http.Response, error) {
	var (
