...
/* 
RetainedEarningsStatementApiService getRetainedEarningsStatement
...
func (a *RetainedEarningsStatementApiService) GetRetainedEarningsStatement(ctx context.Context, companyId string, retainedEarningsStatementLineNumber int32, localVarOptionals *GetRetainedEarningsStatementOpts) (RetainedEarningsStatement, *http.Response, error) {
	var (
...
/* 
RetainedEarningsStatementApiService listRetainedEarningsStatement
...
@return CompaniesApiRetainedEarningsStatementResponse
*/
...
func (a *RetainedEarningsStatementApiService) ListRetainedEarningsStatement(ctx context.Context, companyId string, localVarOptionals *ListRetainedEarningsStatementOpts) (CompaniesApiRetainedEarningsStatementResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiRetainedEarningsStatementResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiRetainedEarningsStatementResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
