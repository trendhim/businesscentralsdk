...
func (a *CompanyApiService) GetCompany(ctx context.Context, companyId string, localVarOptionals *GetCompanyOpts) (Company, *http.Response, error) {
	var (
...
/* 
CompanyApiService listCompanies
...
func (a *CompanyApiService) ListCompanies(ctx context.Context, localVarOptionals *ListCompaniesOpts) (CompaniesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesResponse
	)
