...
/* 
EmployeeApiService getEmployee
...
func (a *EmployeeApiService) GetEmployee(ctx context.Context, companyId string, employeeId string, localVarOptionals *GetEmployeeOpts) (Employee, *http.Response, error) {
	var (
...
/* 
EmployeeApiService listEmployees
...
@return CompaniesApiEmployeesResponse
*/
...
func (a *EmployeeApiService) ListEmployees(ctx context.Context, companyId string, localVarOptionals *ListEmployeesOpts) (CompaniesApiEmployeesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiEmployeesResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiEmployeesResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
EmployeeApiService patchEmployee
...
@return Employee
*/
func (a *EmployeeApiService) PatchEmployee(ctx context.Context, companyId string, employeeId string, contentType string, ifMatch string, body CompaniesApiEmployeesApiRequest) (Employee, *http.Response, error) {
	var (
...
/* 
EmployeeApiService postEmployee
...
@return Employee
*/
func (a *EmployeeApiService) PostEmployee(ctx context.Context, companyId string, contentType string, body CompaniesApiEmployeesRequest) (Employee, *http.Response, error) {
	var (
