...
/* 
PdfDocumentApiService getPdfDocument
...
func (a *PdfDocumentApiService) GetPdfDocument(ctx context.Context, companyId string, pdfDocumentId string, localVarOptionals *GetPdfDocumentOpts) (PdfDocument, *http.Response, error) {
	var (
...
/* 
PdfDocumentApiService getPdfDocumentForPurchaseInvoice
Retrieve the properties and relationships of an object of type pdfDocument for Dynamics 365 Business Central.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
...
func (a *PdfDocumentApiService) GetPdfDocumentForPurchaseInvoice(ctx context.Context, companyId string, purchaseInvoiceId string, pdfDocumentId string, localVarOptionals *GetPdfDocumentForPurchaseInvoiceOpts) (PdfDocument, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
PdfDocumentApiService getPdfDocumentForSalesCreditMemo
Retrieve the properties and relationships of an object of type pdfDocument for Dynamics 365 Business Central.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
...
func (a *PdfDocumentApiService) GetPdfDocumentForSalesCreditMemo(ctx context.Context, companyId string, salesCreditMemoId string, pdfDocumentId string, localVarOptionals *GetPdfDocumentForSalesCreditMemoOpts) (PdfDocument, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
PdfDocumentApiService getPdfDocumentForSalesInvoice
Retrieve the properties and relationships of an object of type pdfDocument for Dynamics 365 Business Central.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
...
func (a *PdfDocumentApiService) GetPdfDocumentForSalesInvoice(ctx context.Context, companyId string, salesInvoiceId string, pdfDocumentId string, localVarOptionals *GetPdfDocumentForSalesInvoiceOpts) (PdfDocument, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
PdfDocumentApiService getPdfDocumentForSalesQuote
Retrieve the properties and relationships of an object of type pdfDocument for Dynamics 365 Business Central.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
...
func (a *PdfDocumentApiService) GetPdfDocumentForSalesQuote(ctx context.Context, companyId string, salesQuoteId string, pdfDocumentId string, localVarOptionals *GetPdfDocumentForSalesQuoteOpts) (PdfDocument, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
PdfDocumentApiService listPdfDocument
...
@return CompaniesApiPdfDocumentResponse
*/
...
func (a *PdfDocumentApiService) ListPdfDocument(ctx context.Context, companyId string, localVarOptionals *ListPdfDocumentOpts) (CompaniesApiPdfDocumentResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiPdfDocumentResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiPdfDocumentResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
PdfDocumentApiService listPdfDocumentForPurchaseInvoice
Returns a list of pdfDocument
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param purchaseInvoiceId id for purchaseInvoice
...
@return CompaniesApiPurchaseInvoicesApiPdfDocumentResponse
*/
...
func (a *PdfDocumentApiService) ListPdfDocumentForPurchaseInvoice(ctx context.Context, companyId string, purchaseInvoiceId string, localVarOptionals *ListPdfDocumentForPurchaseInvoiceOpts) (CompaniesApiPurchaseInvoicesApiPdfDocumentResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiPurchaseInvoicesApiPdfDocumentResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiPurchaseInvoicesApiPdfDocumentResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
PdfDocumentApiService listPdfDocumentForSalesCreditMemo
Returns a list of pdfDocument
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param salesCreditMemoId id for salesCreditMemo
...
@return CompaniesApiSalesCreditMemosApiPdfDocumentResponse
*/
...
func (a *PdfDocumentApiService) ListPdfDocumentForSalesCreditMemo(ctx context.Context, companyId string, salesCreditMemoId string, localVarOptionals *ListPdfDocumentForSalesCreditMemoOpts) (CompaniesApiSalesCreditMemosApiPdfDocumentResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiSalesCreditMemosApiPdfDocumentResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiSalesCreditMemosApiPdfDocumentResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
PdfDocumentApiService listPdfDocumentForSalesInvoice
Returns a list of pdfDocument
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param salesInvoiceId id for salesInvoice
...
@return CompaniesApiSalesInvoicesApiPdfDocumentResponse
*/
...
func (a *PdfDocumentApiService) ListPdfDocumentForSalesInvoice(ctx context.Context, companyId string, salesInvoiceId string, localVarOptionals *ListPdfDocumentForSalesInvoiceOpts) (CompaniesApiSalesInvoicesApiPdfDocumentResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiSalesInvoicesApiPdfDocumentResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiSalesInvoicesApiPdfDocumentResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
PdfDocumentApiService listPdfDocumentForSalesQuote
Returns a list of pdfDocument
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param salesQuoteId id for salesQuote
...
@return CompaniesApiSalesQuotesApiPdfDocumentResponse
*/
...
func (a *PdfDocumentApiService) ListPdfDocumentForSalesQuote(ctx context.Context, companyId string, salesQuoteId string, localVarOptionals *ListPdfDocumentForSalesQuoteOpts) (CompaniesApiSalesQuotesApiPdfDocumentResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiSalesQuotesApiPdfDocumentResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiSalesQuotesApiPdfDocumentResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
