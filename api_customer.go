...
func (a *CustomerApiService) GetCustomer(ctx context.Context, companyId string, customerId string, localVarOptionals *GetCustomerOpts) (Customer, *http.Response, error) {
	var (
...
/* 
CustomerApiService listCustomers
...
@return CompaniesApiCustomersResponse
*/
...
func (a *CustomerApiService) ListCustomers(ctx context.Context, companyId string, localVarOptionals *ListCustomersOpts) (CompaniesApiCustomersResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiCustomersResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiCustomersResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
CustomerApiService patchCustomer
...
@return Customer
*/
func (a *CustomerApiService) PatchCustomer(ctx context.Context, companyId string, customerId string, contentType string, ifMatch string, body CompaniesApiCustomersApiRequest) (Customer, *http.Response, error) {
	var (
...
/* 
CustomerApiService postCustomer
...
@return Customer
*/
func (a *CustomerApiService) PostCustomer(ctx context.Context, companyId string, contentType string, body CompaniesApiCustomersRequest) (Customer, *http.Response, error) {
	var (
