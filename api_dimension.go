...
/* 
DimensionApiService getDimension
...
func (a *DimensionApiService) GetDimension(ctx context.Context, companyId string, dimensionId string, localVarOptionals *GetDimensionOpts) (Dimension, *http.Response, error) {
	var (
...
/* 
DimensionApiService listDimensions
...
@return CompaniesApiDimensionsResponse
*/
...
func (a *DimensionApiService) ListDimensions(ctx context.Context, companyId string, localVarOptionals *ListDimensionsOpts) (CompaniesApiDimensionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiDimensionsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiDimensionsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
