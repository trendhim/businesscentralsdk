...
/* 
CustomerFinancialDetailApiService getCustomerFinancialDetail
...
func (a *CustomerFinancialDetailApiService) GetCustomerFinancialDetail(ctx context.Context, companyId string, customerFinancialDetailId string, localVarOptionals *GetCustomerFinancialDetailOpts) (CustomerFinancialDetail, *http.Response, error) {
	var (
...
/* 
CustomerFinancialDetailApiService getCustomerFinancialDetailForCustomer
Retrieve the properties and relationships of an object of type customerFinancialDetail for Dynamics 365 Business Central.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
...
func (a *CustomerFinancialDetailApiService) GetCustomerFinancialDetailForCustomer(ctx context.Context, companyId string, customerId string, customerFinancialDetailId string, localVarOptionals *GetCustomerFinancialDetailForCustomerOpts) (CustomerFinancialDetail, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
CustomerFinancialDetailApiService listCustomerFinancialDetails
...
@return CompaniesApiCustomerFinancialDetailsResponse
*/
...
func (a *CustomerFinancialDetailApiService) ListCustomerFinancialDetails(ctx context.Context, companyId string, localVarOptionals *ListCustomerFinancialDetailsOpts) (CompaniesApiCustomerFinancialDetailsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiCustomerFinancialDetailsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiCustomerFinancialDetailsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
CustomerFinancialDetailApiService listCustomerFinancialDetailsForCustomer
Returns a list of customerFinancialDetails
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId id for company
 * @param customerId id for customer
...
@return CompaniesApiCustomersApiCustomerFinancialDetailsResponse
*/
...
func (a *CustomerFinancialDetailApiService) ListCustomerFinancialDetailsForCustomer(ctx context.Context, companyId string, customerId string, localVarOptionals *ListCustomerFinancialDetailsForCustomerOpts) (CompaniesApiCustomersApiCustomerFinancialDetailsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiCustomersApiCustomerFinancialDetailsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiCustomersApiCustomerFinancialDetailsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
