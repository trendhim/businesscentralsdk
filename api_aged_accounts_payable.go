...
/* 
AgedAccountsPayableApiService getAgedAccountsPayable
...
func (a *AgedAccountsPayableApiService) GetAgedAccountsPayable(ctx context.Context, companyId string, agedAccountsPayableVendorId string, localVarOptionals *GetAgedAccountsPayableOpts) (AgedAccountsPayable, *http.Response, error) {
	var (
...
/* 
AgedAccountsPayableApiService listAgedAccountsPayable
...
@return CompaniesApiAgedAccountsPayableResponse
*/
...
func (a *AgedAccountsPayableApiService) ListAgedAccountsPayable(ctx context.Context, companyId string, localVarOptionals *ListAgedAccountsPayableOpts) (CompaniesApiAgedAccountsPayableResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiAgedAccountsPayableResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiAgedAccountsPayableResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
