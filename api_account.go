...
func (a *AccountApiService) GetAccount(ctx context.Context, companyId string, accountId string, localVarOptionals *GetAccountOpts) (Account, *http.Response, error) {
	var (
...
/* 
AccountApiService listAccounts
...
@return CompaniesApiAccountsResponse
*/
...
func (a *AccountApiService) ListAccounts(ctx context.Context, companyId string, localVarOptionals *ListAccountsOpts) (CompaniesApiAccountsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiAccountsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiAccountsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
