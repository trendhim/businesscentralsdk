...
/* 
ShipmentMethodApiService deleteShipmentMethod
...
/* 
ShipmentMethodApiService getShipmentMethod
...
func (a *ShipmentMethodApiService) GetShipmentMethod(ctx context.Context, companyId string, shipmentMethodId string, localVarOptionals *GetShipmentMethodOpts) (ShipmentMethod, *http.Response, error) {
	var (
...
/* 
ShipmentMethodApiService listShipmentMethods
...
@return CompaniesApiShipmentMethodsResponse
*/
...
func (a *ShipmentMethodApiService) ListShipmentMethods(ctx context.Context, companyId string, localVarOptionals *ListShipmentMethodsOpts) (CompaniesApiShipmentMethodsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CompaniesApiShipmentMethodsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CompaniesApiShipmentMethodsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
ShipmentMethodApiService patchShipmentMethod
...
@return ShipmentMethod
*/
func (a *ShipmentMethodApiService) PatchShipmentMethod(ctx context.Context, companyId string, shipmentMethodId string, contentType string, ifMatch string, body ShipmentMethod) (ShipmentMethod, *http.Response, error) {
	var (
...
/* 
ShipmentMethodApiService postShipmentMethod
...
@return ShipmentMethod
*/
func (a *ShipmentMethodApiService) PostShipmentMethod(ctx context.Context, companyId string, contentType string, body ShipmentMethod) (ShipmentMethod, *http.Response, error) {
	var (
